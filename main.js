...
const fallbackData = { gps: [{ branch: 'P-35', latitude: 22.5140997, longitude: 88.4082414 }], employees: [{ name: 'Arnab Nazir', branch: 'P-35' }] };
...
function saveSignInAndRedirect(payload) {
    const rawName = String(payload.employee || '').trim();
    ...
    if (typeof SoundFx !== 'undefined' && SoundFx.speak) {
        SoundFx.speak(`Hello ${firstName}, have a nice day!`, redirect);
    } else {
